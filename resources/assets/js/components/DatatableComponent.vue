    ...
    export default {
        ...
        methods: {
            ...
            pushItemOrMetaData(response) {
                ...
                if(self.meta.to > self.limit) {
                    self.limit = self.meta.to
                }
            ...
            toPage(page) {
                ...
                if(this.searchQuery !== '') {
                    requestParam['searchColumns'] = this.dbSearchColumns
                    requestParam['query'] = this.searchQuery
                }

                axios.post(`${this.url}`, requestParam).then(response => {
                    this.loading = false
            ...
            handleSearch: _.debounce( function(e) {
                ...
                if(inputVal.length <= 0 || this.searchQuery === inputVal)
                    return;
